...
export default function RTE({submission, autoFocus=false, onKeyDown}) {
  ...
  return <Row onKeyDown={onKeyDown} className={[{
    'border': isFormFocused// [rRef.current, tRef.current, eRef.current].includes(document.activeElement)
    ...
    <Col>
      <Card>
        <Card.Body>
          ...
          <Card.Text>
            <audio controls src={submission.attachments[0].file} ref={audioRef} />
          </Card.Text>
        </Card.Body>
        <ListGroup className="list-group-flush">
          <ListGroupItem><time dateTime={submission.attachments[0].submitted}>{submission.attachments[0].submitted}</time></ListGroupItem>
