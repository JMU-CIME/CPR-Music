  ...
  return (
    <Layout>
      ...
      <p>
        ...
        processes found in National Standards for Music Education: create,
        perform, respond, and connect and their manifestations in state
        standards for instrumental music education (e.g., New York&apos;s Arts
        Learning Standards, Virginia&apos;s Music Standards of Learning).
      </p>
      ...
      <p>
        ...
        facilitating and assessing individual students&apos; music learning.
        These tools connect with established repertoire on state music education
      ...
      <p>
        ...
        between the Department of Computer Science and the Center for Inclusive
        Music Engagement. Development has been supported by grants from
        University of Rochester&apos;s Eastman School of Music and James Madison
