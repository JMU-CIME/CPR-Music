...
function correctMeasure(measure) {
  ...
  console.log("measure w/ chords:", JSON.parse(JSON.stringify(alteredMeasure)));
  alteredMeasure.note = [...dropHarmony(alteredMeasure)];
  console.log("measure after removal:", JSON.parse(JSON.stringify(alteredMeasure)));
...
function mwCreateVariations(origStr) {
  // console.log('mwCreateVariations', origStr)
